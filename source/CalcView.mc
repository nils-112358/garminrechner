...
class CalcView extends WatchUi.View {
    ...
    static const TOP_Y      as Lang.Number = 82;
    ...
    function onUpdate(dc as Graphics.Dc) as Void {
        ...
        // Zahl mittig oben – kein Kasten
        var dispFont = display.length() > 8 ? Graphics.FONT_SMALL : Graphics.FONT_LARGE;
        dc.setColor(Graphics.COLOR_WHITE, Graphics.COLOR_TRANSPARENT);
        dc.drawText(cx, 38, dispFont, display, Graphics.TEXT_JUSTIFY_CENTER);
